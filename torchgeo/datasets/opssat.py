...
class OPSSAT(NonGeoClassificationDataset):
    ...
    satellite images covering 3 spectral bands and consists of 8 target classes with
    a total of 80 labeled images (10 per class) and 21600 non-labeled images

    Dataset format:

    * rasters are 3-channel GeoTiffs
